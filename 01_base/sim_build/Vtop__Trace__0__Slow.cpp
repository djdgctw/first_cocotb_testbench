...
VL_ATTR_COLD void Vtop___024root__trace_full_0_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullCData(oldp+1,(vlSelfRef.q),4);
    bufp->fullBit(oldp+2,(vlSelfRef.clk));
    bufp->fullCData(oldp+3,(vlSelfRef.d),4);
    bufp->fullCData(oldp+4,(vlSelfRef.dff__DOT__q),4);
    bufp->fullBit(oldp+5,(vlSelfRef.dff__DOT__clk));
    bufp->fullCData(oldp+6,(vlSelfRef.dff__DOT__d),4);
}
